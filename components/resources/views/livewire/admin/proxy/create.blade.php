    ...
    <form wire:submit.prevent="onAddProxy">
        ...
        <div class="form-group">
            ...
            <select wire:model="type" class="form-control" required>
                ...
                <option value="socks45">SOCKS5</option>
            </select>
        </div>

        <div class="form-group">
            <label for="name" class="form-control-label">{{ __('Enter the Proxy list in the format:') }} <code>{{ __('ip:port:username:password') }}</code></label>
