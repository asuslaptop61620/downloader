                            ...
                            @if ( $general->share_icons_status == true )
                              ...
                              <div class="social-share">
                                <div class="share-icons-sm relative">
                                    ...
                                    <a wire:ignore href="https://www.facebook.com/sharer.php?u={{ route('page', $page->slug ) }}"
                                        onclick="window.open('https://www.facebook.com/sharer/sharer.php?u={{ route('page', $page->slug) }}','facebook','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                        data-label="Facebook"
                                    ...
                                    <a wire:ignore href="https://twitter.com/share?url={{ route('page', $page->slug ) }}"
                                        onclick="window.open('https://twitter.com/share?url={{ route('page', $page->slug ) }}','twitter','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                        rel="noopener noreferrer nofollow"
                                        target="_blank"
                                    ...
                                    <a wire:ignore href="https://www.pinterest.com/pin-builder/?url={{ route('page', $page->slug ) }}&media={{ $page->featured_image }}&description={{ str_replace(' ', '%20', $pageTrans->title) }}" wire:ignore
                                        onclick="window.open('https://www.pinterest.com/pin-builder/?url={{ route('page', $page->slug ) }}&media={{ $page->featured_image }}&description={{ str_replace(' ', '%20', $pageTrans->title) }}','pinterest','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                        rel="noopener noreferrer nofollow"
                                        target="_blank"
                                    ...
                                    <a wire:ignore href="https://www.linkedin.com/sharing/share-offsite/?url={{ route('page', $page->slug ) }}" wire:ignore
                                        onclick="window.open('https://www.linkedin.com/sharing/share-offsite/?url={{ route('page', $page->slug ) }}','linkedin','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                        rel="noopener noreferrer nofollow"
                                        target="_blank"
                                    ...
                                    <a wire:ignore href="https://www.reddit.com/submit?url={{ route('page', $page->slug ) }}&title={{ str_replace(' ', '%20', $pageTrans->title) }}" wire:ignore
                                        onclick="window.open('https://www.reddit.com/submit?url={{ route('page', $page->slug ) }}&title={{ str_replace(' ', '%20', $pageTrans->title) }}','reddit','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                        rel="noopener noreferrer nofollow"
                                        target="_blank"
                                    ...
                                    <a wire:ignore href="https://tumblr.com/widgets/share/tool?canonicalUrl={{ route('page', $page->slug ) }}" wire:ignore
                                        onclick="window.open('https://tumblr.com/widgets/share/tool?canonicalUrl={{ route('page', $page->slug ) }}','tumblr','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                        target="_blank"
                                                ...
                                                @foreach ($data['links'] as $key => $value)
                                                  ...
                                                  @if ( ($value['type'] === "mp4" && $value['mute'] === false) || $value['type'] === "jpg" )
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="align-middle">
                                                          <a class="btn bg-gradient-success mb-0" href="{{ $value['url'] }}" title="{{ __('Download') }}" download="{{ $data['title'] }}">
                          ...
                          @if ( $general->share_icons_status == true )
                            ...
                            <div class="social-share text-center">
                              ...
                              <div class="share-icons relative">
                                  ...
                                  <a wire:ignore href="https://www.pinterest.com/pin-builder/?url={{ route('page', $page->slug ) }}&media={{ $page->featured_image }}&description={{ str_replace(' ', '%20', $pageTrans->title) }}"
                                      onclick="window.open('https://www.pinterest.com/pin-builder/?url={{ route('page', $page->slug ) }}&media={{ $page->featured_image }}&description={{ str_replace(' ', '%20', $pageTrans->title) }}','pinterest','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                      rel="noopener noreferrer nofollow"
                                      target="_blank"
                                      class="btn btn-pinterest btn-simple rounded p-2">
                                  ...
                                  <a wire:ignore href="https://www.linkedin.com/sharing/share-offsite/?url={{ route('page', $page->slug ) }}"
                                      onclick="window.open('https://www.linkedin.com/sharing/share-offsite/?url={{ route('page', $page->slug ) }}','linkedin','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                      rel="noopener noreferrer nofollow"
                                      target="_blank"
                                      class="btn btn-linkedin btn-simple rounded p-2">
                                  ...
                                  <a wire:ignore href="https://www.reddit.com/submit?url={{ route('page', $page->slug ) }}&title={{ str_replace(' ', '%20', $pageTrans->title) }}"
                                      onclick="window.open('https://www.reddit.com/submit?url={{ route('page', $page->slug ) }}&title={{ str_replace(' ', '%20', $pageTrans->title) }}','reddit','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                      rel="noopener noreferrer nofollow"
                                      target="_blank"
                                      class="btn btn-reddit btn-simple rounded p-2">
                                  ...
                                  <a wire:ignore href="https://tumblr.com/widgets/share/tool?canonicalUrl={{ route('page', $page->slug ) }}"
                                      onclick="window.open('https://tumblr.com/widgets/share/tool?canonicalUrl={{ route('page', $page->slug ) }}','tumblr','height=500,width=800,resizable=1,scrollbars=yes'); return false;"
                                      target="_blank"
                                      class="btn btn-tumblr btn-simple rounded p-2"
                                      rel="noopener noreferrer nofollow">
